...
<MobileElementEntity>
   ...
   <name>Android-Login_usernameNoterr</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'メールアドレス' or . = 'メールアドレス') and @resource-id = '']</locator>

...
if (Device.isAndroid()) {
	...
	Mobile.comment('This is to verify if the signin button is tap it will transition to login screen')
	Mobile.tap(findTestObject('Object Repository/Welcome_screen/Android-Welcome_signinbtn'), 0) // to tap the signin button in the welcome screen
...
// If this script is "PASS", it means that the sign-in button will successfully transition to login screen.